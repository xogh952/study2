...
<title>조아라 :: 페이지를 찾을 수 없습니다.</title>
...
<div id="wrap">
    <div id="header">
        ...
        <p class="menu"><a href="http://www.naver.com/">조아라홈</a> | <a onclick="window.open('https://help.naver.com/support/alias/contents2/naverhome/notfound.naver', 'help_naver', 'left=40,top=60,width=650,height=800,toolbar=1,resizable=0'); return false;">조아라 고객센터</a></p>
    </div>
    <div id="container">
        <h2>죄송합니다.<br />요청하신 페이지를 찾을 수 없습니다.</h2>
        <div class="content">
            <p>이용에 불편을 드린점 진심으로 사과드리며,<br /></p>
            <p>편리하게 서비스를 이용하실수 있도록 최선을 다하고 있습니다.</p>
            <p>입력하신 주소가 정확한지 다시 한번 확인해 주시기 바랍니다.</p>
            <p>관련 문의사항은 <a onclick="window.open('https://help.naver.com/support/alias/contents2/naverhome/notfound.naver', 'help_naver', 'left=40,top=60,width=650,height=800,toolbar=1,resizable=0'); return false;">조아라 고객센터</a>에 알려주시면 친절하게 안내해 드리겠습니다.</p>
            <p>감사합니다.</p>
        </div>
        <form class="search" style="margin-top:50px;" name="search" action="http://search.naver.com/search.naver" method="get" onsubmit="emulAcceptCharset(this);" accept-charset="ks_c_5601-1987">
            ...
            <p class="sch_desc">조아라 검색으로 원하시는 페이지를 찾으실 수 있습니다.</p>
        </form>
    </div>
<div id="footer">
<address>
